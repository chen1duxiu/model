...
class ExtRandomVerticalFlip(object):
    ...
    def __call__(self, img, lbl):
        ...
        Returns:
            PIL Image: Randomly flipped image.
            PIL Image: Randomly flipped label_json.
        """
        if random.random() < self.p:
...
class ExtToTensor(object):
    ...
    def __call__(self, pic, lbl):
        ...
        Returns:
            Tensor: Converted image and label_json
        """
        if self.normalize:
...
class ExtNormalize(object):
    ...
    def __call__(self, tensor, lbl):
        ...
        Args:
            ...
            tensor (Tensor): Tensor of label_json. A dummy input for ExtCompose
        Returns:
            Tensor: Normalized Tensor image.
            Tensor: Unchanged Tensor label_json
        """
