...
Before running, you should download the PASCAL VOC2010 from http://host.robots.ox.ac.uk/pascal/VOC/voc2010/VOCtrainval_03-May-2010.tar,
PASCAL-Context Dataset from https://www.cs.stanford.edu/~roozbeh/pascal-context/ and annotation file from https://codalabuser.blob.core.
windows.net/public/trainval_merged.json. Then, make the folder
structure as follow:
VOC2010
|
|--Annotations
...
def parse_args():
    ...
    parser.add_argument(
        '--voc_path', default=r'C:\dataset\VOCdevkit\VOC2010', help='pascal voc path', type=str)
    parser.add_argument(
        '--annotation_path',
        default=r'C:\dataset\VOCdevkit\VOC2010',
